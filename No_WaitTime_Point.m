function [ DanChe_KeXing_Speed_SON ] = No_WaitTime_Point(TW,D,workT,v_Set,gen_Vehicle,Wait_Position,Arc_SinglePoint,ArrivalWait_SinglePoint)
sets={};
Surplus=length(gen_Vehicle)-Wait_Position(end);
...
cartProd_Cell=cell(All_cases,4);
cartProd_Cell(:,4)={0};
for cases_1=1: All_cases
    cartProd_Cell{cases_1,1}=[Arc_SinglePoint(1:Wait_Position(end)-1),cartProd(cases_1,:)];
